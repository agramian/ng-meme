angular.module('memeFactory', [])
  .factory("MemeAPI", function($timeout, $http) {
    ...
    MemeAPI.prototype.drawImageFromRawData = function(rawImageData) {
      if (rawImageData) {
        var blob = new Blob([rawImageData], {
    ...
    MemeAPI.prototype.loadImage = function(image) {
      ...
      if (image.indexOf(".jpg") > -1 || image.indexOf(".png") > -1 || image.indexOf(".gif") > -1 || image.indexOf(".svg") > -1 || image.indexOf('http') == 0) {
        ...
        if (this.imageExtension) {
          if (this.imageExtension[0] == ".jpg" || this.imageExtension[0] == ".jpeg") {
    ...
    MemeAPI.prototype.resizeMeme = function(width, height) {
      ...
      var self = this;
      this.resizePromise = $timeout(function() {
        self.drawMeme();
      }, 250);
